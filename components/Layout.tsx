              ...
              <div className="flex items-center">
                ...
                {user && (
                  <nav className="ml-10 flex items-center space-x-4">
                    <Link
                      href={user.type === 'promoter' ? '/events/manage' : '/events/my-applications'}
              ...
              <div className="flex items-center">
                {user ? (
                  <Menu as="div" className="relative inline-block">
                    {({ open }) => (
                      <>
                        <Menu.Button className="flex items-center space-x-3 text-white px-5 py-2.5 rounded-xl bg-gradient-to-r from-accent-purple/20 to-accent-pink/20 backdrop-blur-md border border-white/10 hover:border-white/20 shadow-lg hover:shadow-accent-purple/20 transition-all duration-300">
                          {subscription?.plan && (
                          ...
                          <svg 
                            className={`w-5 h-5 text-gray-300 transition-transform duration-300 ${open ? 'rotate-180' : ''}`} 
                            fill="none" 
                            viewBox="0 0 24 24" 
                            stroke="currentColor"
                          >
                        ...
                        >
                          <Menu.Items className="absolute right-0 w-72 mt-2 origin-top-right bg-dark-800/95 backdrop-blur-xl rounded-2xl shadow-2xl ring-1 ring-white/10 border border-white/5 focus:outline-none">
                            {/* Header do Menu */}
                            ...
                            <div className="py-2 px-2">
                              ...
                              <div className="px-2 py-2 mt-2 border-t border-white/5">
                                <button
                                  ...
                                  className="w-full flex items-center px-4 py-2.5 text-sm text-red-400 hover:text-red-300 hover:bg-white/5 rounded-lg transition-colors duration-200"
                                >
